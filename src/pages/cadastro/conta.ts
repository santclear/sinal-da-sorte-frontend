...
export class ContaPage {
	...
	constructor(
		...
		this.formGroup = this.formBuilder.group({
			...
			dataDeNascimento: ['1', [Validators.required, Validators.minLength(8)]],
			cpf: ['06134596280', [Validators.required, Validators.minLength(11)]],
			...
			telefone1: ['977261827', [Validators.required, Validators.minLength(11)]],
