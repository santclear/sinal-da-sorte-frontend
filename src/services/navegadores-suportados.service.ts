...
export class NavegadoresSuportadosService {
	...
	toastNavegadorNaoSuportado(nome: string) {
		try {
			let toast = this.toastCtrl.create({
				message: `ATENÇÃO! O navegador ${nome} não é suportado pelo Sinal da Sorte. O aplicativo poderá apresentar comportamentos indesejados.
